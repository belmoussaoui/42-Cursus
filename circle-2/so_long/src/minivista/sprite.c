...
/*   Updated: 2022/03/13 22:23:29 by bel-mous         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	load_texture(t_render *render, char *filepath, t_sprite *sprite)
{
	...
	sprite->image.pixels = mlx_get_data_addr(sprite->image.texture,
		&sprite->image.bits_per_pixel, &sprite->image.line_length, &sprite->image.endian);
...
void	create_image(t_render *render, t_image *image, int w, int h)
{
	...
	image->pixels = mlx_get_data_addr(image->texture, &image->bits_per_pixel,
